...
export const WorkshopForm = () => {
    ...
    return (
            ...
            {/* --- Hero Section --- */}
            <div className="relative py-24 px-6 md:px-12 border-b border-(--guide-color) overflow-hidden text-center rounded-t-3xl">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 text-sm md:text-base p-5 mb-8 max-w-3xl  mx-auto bg-black/40 border border-(--guide-color) rounded-2xl shadow-[0_0_30px_-10px_rgba(59,130,246,0.1)]">
                    ...
                    <a 
                        ...
                        className=" inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white px-6 py-3 rounded-xl text-sm font-medium transition-all duration-200 cursor-pointer"
                    >
                ...
                <form className="max-w-2xl mx-auto space-y-8" onSubmit={handleSubmit}>
                    ...
                    <div className="pt-4 flex justify-end">
                        <button 
                            ...
                            className={` group flex items-center gap-2 bg-white text-black px-8 py-3.5 rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg shadow-white/5
                            ${
                              isSubmitting
